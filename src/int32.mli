...
(** [count_leading_zeros n] returns the number of most-significant zero bits before the
    ...
    that is 32. *)
val count_leading_zeros : local_ int32 -> int32
...
val count_leading_zeros_nonzero_arg : local_ int32 -> int32
...
(** [count_trailing_zeros n] returns the number of least-significant zero bits before the
    ...
    [n], that is 32. *)
val count_trailing_zeros : local_ int32 -> int32
...
val count_trailing_zeros_nonzero_arg : local_ int32 -> int32

(** [count_set_bits n] returns the number of bits that are 1 in [n]. *)
val count_set_bits : local_ int32 -> int32
...
val shift_left : local_ int32 -> local_ int32 -> local_ int32
...
val shift_right : local_ int32 -> local_ int32 -> local_ int32
...
val shift_right_logical : local_ int32 -> local_ int32 -> local_ int32

module Naive : Naive_ints.S with type t = int32
