...
(** [count_leading_zeros n] returns the number of most-significant zero bits before the
    ...
    that is 64. *)
val count_leading_zeros : local_ int64 -> int64
...
val count_leading_zeros_nonzero_arg : local_ int64 -> int64
...
(** [count_trailing_zeros n] returns the number of least-significant zero bits before the
    ...
    [n], that is 64. *)
val count_trailing_zeros : local_ int64 -> int64
...
val count_trailing_zeros_nonzero_arg : local_ int64 -> int64

(** [count_set_bits n] returns the number of bits that are 1 in [n]. *)

val count_set_bits : local_ int64 -> int64
...
val shift_left : local_ int64 -> local_ int64 -> local_ int64
...
val shift_right : local_ int64 -> local_ int64 -> local_ int64
...
val shift_right_logical : local_ int64 -> local_ int64 -> local_ int64
